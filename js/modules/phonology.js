...
window.PhonologyModule = {
    ...
    autoRomanize() {
        ...
        // Smart romanization mappings (matching quick start system)
        const romanizations = {
            // Vowels - matching quick start orthography
            'a': 'a', 'e': 'e', 'i': 'i', 'o': 'o', 'u': 'u',
            'ə': 'ë', 'ɛ': 'è', 'ɔ': 'ò', 'ɪ': 'ì', 'ʊ': 'ù',
            'ʌ': 'ú', 'æ': 'ä', 'ø': 'ö', 'œ': 'ő', 'y': 'ü',
            'ɨ': 'î', 'ɯ': 'û', 'ɤ': 'ô', 'ɐ': 'á', 'ɑ': 'â',
            ...
            // Consonants - matching quick start orthography
    ...
    suggestOrthography() {
        ...
        // Alternative suggestions that match the quick start system
        const suggestions = {
            'ʃ': ['sh', 'ş', 'č', 'x'],
            'ʒ': ['zh', 'ž', 'j', 'z'],
            'θ': ['th', 'þ', 't', 'f'],
